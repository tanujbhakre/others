...
public final class HibernateUtil {
	 ...
	 * @param exclude
	 *            Details of what all thing to exclude
	 * @return
	 */
	public static Criteria populateCriteria(SearchDetails details,
		...
		if (!exclude.getPaging()) {
			if (details.getOffset() != null && details.getSize() != null) {
				criteria.setFirstResult(details.getOffset().intValue() - 1);
				criteria.setMaxResults(details.getSize().intValue());
			}
		}
		return criteria;
	}
